...
local ConfigFile = "Bastard X Hub/Config/BastardX_" .. gameName .. ".json"
...
-- Load Icons from remote URL
local Icons = {}
local iconSuccess, iconResult = pcall(function()
    return loadstring(game:HttpGet("https://raw.githubusercontent.com/NexorHub/Teste/refs/heads/main/Icons.lua"))()
end)
if iconSuccess and type(iconResult) == "table" then
    Icons = iconResult
else
    -- Fallback icons if URL fails
    Icons = {
...
local Themes = {
    ["Dark"] = {
        ...
        TopbarColor     = Color3.fromRGB(18, 18, 18),
    ...
    ["Midnight Blue"] = {
        Name            = "Midnight Blue",
        AccentColor     = Color3.fromRGB(99, 155, 255),
        BackgroundColor = Color3.fromRGB(8, 12, 24),
        TopbarColor     = Color3.fromRGB(14, 20, 40),
        TextColor       = Color3.fromRGB(220, 230, 255),
        SubTextColor    = Color3.fromRGB(120, 150, 200),
        SectionColor    = Color3.fromRGB(16, 24, 50),
        ToggleOn        = Color3.fromRGB(99, 155, 255),
        ToggleOff       = Color3.fromRGB(30, 40, 80),
    },
    ["Blood Red"] = {
        Name            = "Blood Red",
        AccentColor     = Color3.fromRGB(220, 50, 50),
        BackgroundColor = Color3.fromRGB(12, 8, 8),
        TopbarColor     = Color3.fromRGB(22, 10, 10),
        TextColor       = Color3.fromRGB(240, 210, 210),
        SubTextColor    = Color3.fromRGB(180, 120, 120),
        SectionColor    = Color3.fromRGB(28, 14, 14),
        ToggleOn        = Color3.fromRGB(220, 50, 50),
        ToggleOff       = Color3.fromRGB(70, 25, 25),
    },
    ["Neon Green"] = {
        Name            = "Neon Green",
        AccentColor     = Color3.fromRGB(57, 255, 20),
        BackgroundColor = Color3.fromRGB(8, 14, 8),
        TopbarColor     = Color3.fromRGB(10, 22, 10),
        TextColor       = Color3.fromRGB(200, 240, 200),
        SubTextColor    = Color3.fromRGB(100, 180, 100),
        SectionColor    = Color3.fromRGB(14, 28, 14),
        ToggleOn        = Color3.fromRGB(57, 255, 20),
        ToggleOff       = Color3.fromRGB(25, 60, 25),
    },
    ["Purple Haze"] = {
        Name            = "Purple Haze",
        AccentColor     = Color3.fromRGB(180, 80, 255),
        BackgroundColor = Color3.fromRGB(14, 8, 22),
        TopbarColor     = Color3.fromRGB(22, 12, 36),
        TextColor       = Color3.fromRGB(230, 210, 255),
        SubTextColor    = Color3.fromRGB(160, 120, 200),
        SectionColor    = Color3.fromRGB(28, 16, 46),
        ToggleOn        = Color3.fromRGB(180, 80, 255),
        ToggleOff       = Color3.fromRGB(60, 25, 90),
    },
    ["Cyberpunk"] = {
        Name            = "Cyberpunk",
        ...
        SubTextColor    = Color3.fromRGB(180, 160, 80),
        SectionColor    = Color3.fromRGB(18, 18, 30),
        ToggleOn        = Color3.fromRGB(255, 220, 0),
        ToggleOff       = Color3.fromRGB(60, 50, 0),
    },
    ["Rosé"] = {
        Name            = "Rosé",
        AccentColor     = Color3.fromRGB(255, 105, 180),
        BackgroundColor = Color3.fromRGB(18, 10, 14),
        TopbarColor     = Color3.fromRGB(28, 14, 20),
        TextColor       = Color3.fromRGB(255, 220, 235),
        SubTextColor    = Color3.fromRGB(200, 140, 170),
        SectionColor    = Color3.fromRGB(36, 18, 26),
    ...
    ["Arctic"] = {
        ...
        BackgroundColor = Color3.fromRGB(8, 14, 20),
        TopbarColor     = Color3.fromRGB(12, 22, 32),
        TextColor       = Color3.fromRGB(200, 235, 255),
        SubTextColor    = Color3.fromRGB(100, 170, 210),
        SectionColor    = Color3.fromRGB(16, 28, 42),
        ToggleOn        = Color3.fromRGB(120, 220, 255),
        ToggleOff       = Color3.fromRGB(30, 65, 90),
    },
}
...
function BastardXHub:Window(GuiConfig)
    ...
    GuiConfig.Footer       = GuiConfig.Footer or "Bastard X Hub"
    GuiConfig.Color        = GuiConfig.Color or ActiveTheme.AccentColor
    GuiConfig["Tab Width"] = GuiConfig["Tab Width"] or 120
    GuiConfig.Version      = GuiConfig.Version or 1
    GuiConfig.Theme        = GuiConfig.Theme or "Dark"

    ApplyTheme(GuiConfig.Theme)
    GuiConfig.Color = ActiveTheme.AccentColor

    CURRENT_VERSION        = GuiConfig.Version
    LoadConfigFromFile()

    -- Load saved theme/transparency from config
    if ConfigData["_BXH_Theme"] then
        ApplyTheme(ConfigData["_BXH_Theme"])
        GuiConfig.Color = ActiveTheme.AccentColor
    end
    local _guiTransparency = ConfigData["_BXH_Transparency"] or 0
    ...
    if GuiConfig.Theme and not Themes[GuiConfig.Theme] then
        -- Legacy: theme is an asset ID for image background
        Main:Destroy()
        ...
        Main.BackgroundTransparency = _guiTransparency
    end
    ...
    Top.BackgroundColor3 = ActiveTheme.TopbarColor
    ...
    Close.Activated:Connect(function()
        ...
        Gradient.Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0.0,  ActiveTheme.AccentColor),
            ColorSequenceKeypoint.new(0.5,  ActiveTheme.SubTextColor or Color3.fromRGB(160,160,160)),
            ColorSequenceKeypoint.new(1.0,  ActiveTheme.AccentColor)
        })
    ...
    do
        ...
        CfgSection:AddDropdown({
            ...
            Flag   = "_BXH_Theme",
            List   = themeNames,
            Value  = ConfigData["_BXH_Theme"] or "Dark",
            Callback = function(selected)
                ...
                for _, child in Main:GetDescendants() do
                    if child:IsA("Frame") and child.Name == "ChooseFrame" then
                        ...
                        if s then s.Color = ActiveTheme.AccentColor end
                    end
        ...
        CfgSection:AddSlider({
            ...
            Min     = 0,
            Max     = 90,
            Default = math.floor((ConfigData["_BXH_Transparency"] or 0) * 100),
            Callback = function(val)
                local t = val / 100
                Main.BackgroundTransparency = t
                ConfigData["_BXH_Transparency"] = t
                SaveConfig()
            end
        })
        ...
        SizeSection:AddDropdown({
            Name  = "Size Preset",
            Flag  = "_BXH_SizePreset",
            List  = { "Small (480x300)", "Medium (640x400)", "Large (820x520)", "Wide (960x420)" },
            Value = ConfigData["_BXH_SizePreset"] or "Medium (640x400)",
            Callback = function(selected)
                local presets = {
                    ["Small (480x300)"]  = { 480, 300 },
                    ["Medium (640x400)"] = { 640, 400 },
                    ["Large (820x520)"]  = { 820, 520 },
                    ["Wide (960x420)"]   = { 960, 420 },
                }
                ...
                if p then
                    TweenService:Create(
                        ...
                        { Size = UDim2.new(0, p[1], 0, p[2]) }
                    ):Play()
                end
                ConfigData["_BXH_SizePreset"] = selected
                SaveConfig()
            end
        })
