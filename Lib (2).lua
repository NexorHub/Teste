...
function BastardXHub:Window(GuiConfig)
    ...
    -- Helper: retorna a cor de fundo tintada do tema para painéis de dropdown
    ...
    Tabs._accentRefs = {
        ...
        dropPanels   = {},   -- { outer=DropdownSelect, inner=DropdownSelectReal, search=SearchBox }
    }
    ...
    -- Painel global do dropdown: registrado para SetTheme atualizar a cor de fundo
    ...
    function Tabs:AddTab(TabConfig)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            function Items:AddDropdown(DropdownConfig)
                ...
                -- Registra apenas o SearchBox desta instância — DropdownSelect/Real já
                -- estão no entry global registrado em _accentRefs na init dos Tabs.
                table.insert(Tabs._accentRefs.dropPanels, {
                    outer  = nil,
                    inner  = nil,
                    search = SearchBox,
    ...
    --- Troca o tema de fundo em tempo real e sincroniza o FloatBtn e painéis de dropdown
    ...
    function Tabs:SetTheme(themeName)
        ...
        if col then
            ...
            -- Sincroniza cor de fundo dos painéis de dropdown com o tema
